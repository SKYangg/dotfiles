...
维护 Claude Code 与 Codex 的配置文件、上下文规则模板，以及 AI 工具的共享设置。

## 文件清单

| 文件 | symlink 目标 | 用途 |
|------|-------------|------|
| `.claude/CLAUDE.md` | `~/.claude/CLAUDE.md` | Claude Code 原生全局行为规则 |
...
- `.claude/CLAUDE.md` 定义 Claude Code 的通用行为：调研、范围控制、安全和验证
- `.codex/AGENTS.md` 定义 Codex 的全局工作约束；Git 专项流程由独立 skill 提供
